...
class DemotivatorMod(loader.Module):
    ...
    async def mqcmd(self, message):
        ...
        text = "“" + text + "„"
        bf = requests.get(
            "https://github.com/hessfire/some-ftg-modules-modded-by-me/raw/main/impact.ttf"
        ).content
...
async def procces_img(message, way):
    ...
    if col == 2:
        draw.multiline_text((x, y), t, (0, 0, 0), font=font, align="center")
    else:
        draw.multiline_text((x, y), t, (255, 255, 255), font=font, align="center")
